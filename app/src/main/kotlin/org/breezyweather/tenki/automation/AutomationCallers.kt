...
object AutomationCallers {
    ...
    private fun signingSha256(context: Context, pkg: String): String? = runCatching {
        ...
        // `signingInfo` and GET_SIGNING_CERTIFICATES are API 28, and this fork's minSdk is **23** —
        // lower than the 26 the reference implementation assumed, so the older branch covers a
        // wider range here. On a 23–27 device the flag is accepted and `signingInfo` comes back
        // null, so WITHOUT this
